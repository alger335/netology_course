...
HELP = '''Доступные команды:
    ...
    * /todo date task category - добавить задачу в список, пример: /todo 4-02 Сходить в магазин покупки
...
def add_todo(date, task):             # функция "add_todo", принимает параметры date, task
